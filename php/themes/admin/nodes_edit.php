...
<div class='cell'>
<form accept-charset="UTF-8" action="/admin/nodes/edit/<?=$cateinfo['cid']?>" class="simple_form form-horizontal" id="edit_user_1" method="post" novalidate="novalidate">
...
<div class="controls">
<input class="string required" id="cname" name="cname" size="50" type="text" value="<?=$cateinfo['cname']?>" /></div></div>
...
<option selected="selected" value="<?=$cateinfo['pid']?>"><?=$cateinfo['pid']?></option>
...
<div class="controls">
<input class="string optional" id="keywords" name="keywords" size="50" type="text" value="<?=$cateinfo['keywords']?>" /></div></div>
<div class="control-group text optional">
<label class="text optional control-label" for="content">分类简介</label>
<div class="controls">
<textarea class="text optional span4" cols="40" id="content" name="content" rows="5"><?=$cateinfo['content']?></textarea></div></div>
