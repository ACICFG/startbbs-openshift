...
$(document).ready(function() {
    ...
    $.ajax({
		...
		success: function(data){
				...
				$("#result3").append(data.msg3).fadeIn(4000);
				$("#result4").append(data.msg4).fadeIn(6000);
				$("#result5").append(data.msg5).fadeIn(8000);
				$("#result6").append(data.msg6).fadeIn(10000);
				$("#result_v").append(data.msg_v).fadeIn(12000);
				$("#finish").append(data.finish).fadeIn(14000);
...
<div class='control-group'>
    ...
    <dt></dt>
    <dd id="result3" style="display:none" class="green"></dd>
    <dt></dt>
    <dd id="result4" style="display:none" class="green"></dd>
    <dt></dt>
    <dd id="result5" style="display:none" class="green"></dd>
    <dt></dt>
    <dd id="result6" style="display:none" class="green"></dd>
    <dt></dt>
