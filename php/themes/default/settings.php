...
<div class="controls">
<input class="string optional span4" id="user_account_attributes_signature" name="qq" size="50" type="text" value="<?=$qq?>" />
</div></div>
<div class="control-group string optional">
<label class="string optional control-label" for="user_account_attributes_signature">签名</label>
<div class="controls">
<input class="string optional span4" id="user_account_attributes_signature" name="signature" size="50" type="text" value="<?=$signature?>" />
</div></div>
<div class="control-group text optional">
<label class="text optional control-label" for="user_account_attributes_introduction">个人简介</label>
<div class="controls">
<textarea class="text optional span4" cols="40" id="user_account_attributes_introduction" name="introduction" rows="5"><?=$introduction?></textarea>
</div></div>
